    ...
    <div className="relative">
      ...
      {showMenu && (
        <div className="w-64 h-dvh bg-white dark:bg-zinc-700 absolute top-0 right-0 md:hidden flex flex-col">
          ...
          <div className="flex flex-col space-y-1 child:pr-5 child:my-4 child-hover:text-orange-300 font-dana text-base">
            ...
            <div className="flex flex-col group">
              ...
              <div className=" hidden group-hover:block transition-all w-full child:pr-9 child:text-black child-hover:text-orange-300 child:my-1 child:text-sm">
                <div>قهوه ویژه</div>
      ...
      {showCart && (
        <div className="w-64 h-dvh bg-white dark:bg-zinc-700 absolute top-0 left-0 md:hidden flex flex-col items-center">
          <div className="flex justify-between w-full h-16 px-4 items-center bg-slate-50 dark:bg-zinc-600">
            <svg onClick={() => setShowCart(false)} className="w-9 h-9">
              <use href="#close"></use>
            </svg>
          ...
          <div className="flex flex-col h-full justify-between">
            ...
            <div className="flex flex-col items-center justify-center">
              ...
              <hr className="text-gray-400 w-[90%] mt-4" />
              <div className="flex my-4">
                <div>
                  <Image
                    src="/img/p1.png"
            ...
            {/* footer */}
            <div className="flex justify-between w-full mt-4 px-2 pb-4">
              <div className="child:font-dana flex flex-col">
                <span className="text-xs text-gray-400">مبلغ قابل پرداخت</span>
                <span>
                  <span className="text-[20px]">350,000</span>{" "}
                  <span className="tracking-tighter">تومان</span>
                </span>
              </div>
              <div className="w-20 h-10 bg-teal-600 dark:bg-emerald-500 font-dana text-white rounded-xl flex justify-center items-center">
                <Link href="#" className=" ">
                  ثبت سفارش
                </Link>
              </div>
